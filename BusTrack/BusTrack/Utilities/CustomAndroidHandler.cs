...
namespace BusTrack.Utilities
{
    internal class CustomAndroidClientHandler : HttpClientHandler
    {
        ...
        protected void AssertSelf()
        {
            if (!disposed)
                return;
            throw new ObjectDisposedException(nameof(CustomAndroidClientHandler));
        }
    ...
    internal class AndroidHttpResponseMessage : HttpResponseMessage
    {
        ...
        /// <summary>
        /// Set to the same value as <see cref="CustomAndroidClientHandler.RequestNeedsAuthorization"/>
        /// </summary>
